# Boas vindas ao repositório do projeto React Testing Librarys!

## Sobre o projeto

O objetivo desse projeto foi trabalhar testes usando a biblioteca `React Testing Library` (RTL). Conceitos como `mocks` e `Router` foram trabalhados. 
---
...
```javascript
  ...
  git clone git@github.com:joaogrs/reactTestingLibrary.git
```

3. As funções de cada requisitos estão dentro da pasta `src/tests`.
